...
class ElebeeAdmin {
    ...
    public function enqueueStyles() {
        ...
        wp_enqueue_style( $this->themeName . '-elementor', get_stylesheet_directory_uri() . '/Admin/css/elementor-rto-admin.css', [], $this->version, 'all' );
    ...
    public function enqueueScripts() {
        ...
        wp_enqueue_script( $this->themeName, get_stylesheet_directory_uri() . '/Admin/js/elementor-rto-admin.js', [ 'jquery' ], $this->version, false );
    ...
    public function enqueueEditorStyles() {
        ...
        wp_enqueue_style( $this->themeName . '-editor', get_stylesheet_directory_uri() . '/Admin/css/elementor-rto-editor.css', [], $this->version, 'all' );
    ...
    public function enqueueEditorScripts() {
        ...
        wp_enqueue_script( $this->themeName . '-editor', get_stylesheet_directory_uri() . '/Admin/js/elementor-rto-editor.js', [ 'jquery' ], $this->version, true );
