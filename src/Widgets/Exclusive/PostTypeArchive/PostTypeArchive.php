...
namespace Elebee\Widgets\Exclusive\PostTypeArchive;
...
class PostTypeArchive extends ElebeeWidget {
    ...
    public function get_title() {
        return __( 'Post type archive', 'elementor-rto' );
    }
    ...
    public function enqueueStyles() {
        wp_enqueue_style( $this->get_name(), plugin_dir_url( __FILE__ ) . 'css/' . $this->get_name() . '.css' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'archive_section',
            [
                'label' => __( 'Archive settings', 'elementor-rto' ),
            ]
        );
        ...
        $this->add_control(
            'type',
            [
                'label' => __( 'Post type', 'elementor-rto' ),
        ...
        $this->add_control(
            'count',
            [
                'label' => __( 'Number of results', 'elementor-rto' ),
        ...
        $this->add_responsive_control(
            'per_row',
            [
                'label' => __( 'Per row', 'elementor-rto' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'default' => 4,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'horizontal_spacing',
            [
                'label' => __( 'Horizontal spacing', 'elementor-rto' ),
        ...
        $this->add_responsive_control(
            'vertical_spacing',
            [
                'label' => __( 'Vertical spacing', 'elementor-rto' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'effect',
            [
                'label' => __( 'Effect', 'elementor-rto' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'effect-grayscale',
                'options' => [
                    'effect-grayscale' => __( 'Grayscale', 'elementor-rto' ),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Slide color', 'elementor-rto' ),
        ...
        $this->add_control(
            'transition',
            [
                'label' => __( 'Transition', 'elementor-rto' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 's' ],
                'range' => [
                    's' => [
        ...
        if ( $this->isForArchive ) {
            $this->start_controls_section(
                'archive_divider',
                [
                    'label' => __( 'Divider', 'elementor-rto' ),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
            );
            ...
            $this->add_control(
                'divider_style',
                [
                    'label' => __( 'Style', 'elementor-rto' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'solid',
                    'options' => [
                        'solid' => __( 'Solid', 'elementor-rto' ),
                        'dashed' => __( 'Dashed', 'elementor-rto' ),
                        'dotted' => __( 'Dotted', 'elementor-rto' ),
                    ],
                    'selectors' => [
            ...
            $this->add_control(
                'divider_spacing',
                [
                    'label' => __( 'Spacing', 'elementor-rto' ),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 2,
            ...
            $this->start_controls_section(
                'more_link',
                [
                    'label' => __( 'More link', 'elementor-rto' ),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
            );
    ...
    private function addTaxonomyControls() {
        foreach ( $this->postTypes as $typeName => $postType ) {
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Taxonomy', 'elementor-rto' ),
                    'type' => Controls_Manager::SELECT,
