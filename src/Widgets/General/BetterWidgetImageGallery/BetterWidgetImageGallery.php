<?php
namespace Elebee\Widgets\General\BetterWidgetImageGallery;
...
use Elebee\Widgets\BetterWidgetImageGallery\Lib\Album;
use Elebee\Widgets\BetterWidgetImageGallery\Lib\Renderer;
use Elebee\Widgets\BetterWidgetImageGallery\Lib\Gallery;
use Elebee\Widgets\BetterWidgetImageGallery\Lib\Image;
...
class BetterWidgetImageGallery extends ElebeeWidget {
    ...
    public function enqueueStyles() {
        ...
        wp_enqueue_style( $this->get_name(), get_stylesheet_directory_uri() . '/Widgets/General/BetterWidgetImageGallery/css/better-widget-image-gallery.css', [], Elebee::VERSION, 'all' );
